...
str_replace('/','',$p->kode_pembelian) }}">
    ...
    str_replace('/','',$p->kode_pembelian) }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/transaksi/storeupdate" method="post" class="form-floating">
                            @csrf
        ...
        </div> <!-- Ini tampil form delete transaksi -->
        <div class="modal fade" id="ModalDeletepembelian{{$p->kode_pembelian}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/transaksi/delete/{{$p->kode_pembelian}}" method="get" class="form-floating"> @csrf <div>
